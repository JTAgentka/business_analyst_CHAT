...
import { createCzechBankingGuardrail } from './businessAnalyst/czechGuardrails';
...
export function createModerationGuardrail(companyName: string) {
  // Use Czech-specific guardrail for J&T Bank
  if (companyName === 'J&T Bank') {
    return createCzechBankingGuardrail(companyName);
  }
  
  // Default guardrail for other scenarios
  return {
